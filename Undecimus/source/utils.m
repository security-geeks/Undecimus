...
bool supportsExploit(exploit_t exploit) {
    ...
    switch (exploit) {
        ...
        case voucher_swap_exploit: {
            ...
            minKernelBuildVersion = @"4397.0.0.2.4~1";
            maxKernelBuildVersion = @"4903.232.2~1";
            break;
        }
        ...
        case deja_xnu_exploit: {
            minKernelBuildVersion = @"4397.0.0.2.4~1";
            maxKernelBuildVersion = @"4570.70.24~3";
            if (jailbreakEnabled())
                return false;
            break;
        }
        ...
        case kalloc_crash: {
            minKernelBuildVersion = @"4397.0.0.2.4~1";
            maxKernelBuildVersion = @"4903.252.2~1";
            break;
        }
        default:
            return false;
    ...
    if (minKernelBuildVersion != nil && maxKernelBuildVersion != nil) {
        ...
        if (kernelBuildVersion != nil) {
            if (compareVersion(kernelBuildVersion, minKernelBuildVersion) != NSOrderedAscending && compareVersion(kernelBuildVersion, maxKernelBuildVersion) != NSOrderedDescending) {
                return true;
            }
        }
    }
